...
<script>
  ...
  function ggbOnInit(param) {
    ...
    // init update listeners for controller
      ...
      controller.registerObjectUpdateListener("γ", () => syncValue(controller, "γ", poincare, "th3"));
	  }    
	...
	syncValue(controller, "α", poincare, "th1");
      	...
      	syncValue(controller, "γ", poincare, "th3");
  ...
  var controller = new GGBApplet(createGGBParams("controller", "eszrsufj", {width: 600, height: 450}), true);
  var poincare = new GGBApplet(createGGBParams("poincare", "ahkj4cpw",{enableRightClick: true}), true);
